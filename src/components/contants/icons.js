// her henter vi alle iconnerne ned hom vi skal bruge
export const back = require("../../assets/icons/back.png");
export const car = require("../../assets/icons/car.png");
export const motorcycle = require("../../assets/icons/biking-solid.png");
export const cutlery = require("../../assets/icons/cutlery.png");
export const dollar = require("../../assets/icons/dollar-sign-solid.png");
export const thumpsup = require("../../assets/icons/thumbs-up-solid.png");
...
export const minus = require("../../assets/icons/minus-solid.png");
export const plus = require("../../assets/icons/plus-solid.png");
export const home = require("../../assets/icons/home-solid.png");
